...
// func selectActiveCoAuthorWithFzf(activeCoAuthors []models.CoAuthor) (models.CoAuthor, error) {
...
// func selectMultipleActiveCoAuthors(activeCoAuthors []models.CoAuthor) ([]models.CoAuthor, error) {
// 	if len(activeCoAuthors) == 0 {
